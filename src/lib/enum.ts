...
export enum AccessCredentialDisable {
	NONE = 0,
	DISABLE = 1,
	DISABLE_MANUAL = 2,
	DISABLE_LOCKOUT = 3,
...
export enum AccessCredentialDisableReason {
	DISABLED = 0,
...
export enum AccessPassbackMode {
	PASSBACK_OFF = 0,
	HARD_PASSBACK = 1,
	SOFT_PASSBACK = 2,
}
...
export enum AccessZoneOccupancyState {
	NORMAL = 0,
	BELOW_LOWER_LIMIT = 1,
	AT_LOWER_LIMIT = 2,
	AT_UPPER_LIMIT = 3,
...
export enum AuthorizationExemption {
	PASSBACK = 0,
	OCCUPANCY_CHECK = 1,
	ACCESS_RIGHTS = 2,
	LOCKOUT = 3,
...
export enum EscalatorOperationDirection {
	UNKNOWN = 0,
	STOPPED = 1,
	UP_RATED_SPEED = 2,
	UP_REDUCED_SPEED = 3,
...
export enum LifeSafetyOperation {
	NONE = 0,
	SILENCE = 1,
	SILENCE_AUDIBLE = 2,
	SILENCE_VISUAL = 3,
...
export enum LiftCarDoorCommand {
	NONE = 0,
	OPEN = 1,
	CLOSE = 2,
}

export enum LiftCarDriveStatus {
	UNKNOWN = 0,
	STATIONARY = 1,
	BRAKING = 2,
	ACCELERATE = 3,
...
export enum LightingInProgress {
	IDLE = 0,
	FADE_ACTIVE = 1,
	RAMP_ACTIVE = 2,
	NOT_CONTROLLED = 3,
...
export enum LightingTransition {
	NONE = 0,
	FADE = 1,
	RAMP = 2,
}
...
export enum NetworkNumberQuality {
	UNKNOWN = 0,
	LEARNED = 1,
...
export enum NetworkPortCommand {
	IDLE = 0,
	DISCARD_CHANGES = 1,
...
export enum EventTransitionBits {
	TO_OFFNORMAL = 0,
	TO_FAULT = 1,
	TO_NORMAL = 2,
}

export enum LimitEnable {
	LOW_LIMIT_ENABLE = 0,
	HIGH_LIMIT_ENABLE = 1,
}
 ...
 */
export enum MaxApduLengthAccepted {
	OCTETS_50 = 0b0000,
	OCTETS_128 = 0b0001,
	OCTETS_206 = 0b0010,
	OCTETS_480 = 0b0011,
 ...
 */
export enum MaxSegmentsAccepted {
	SEGMENTS_0 = 0b000 << 4,
	SEGMENTS_2 = 0b001 << 4,
	SEGMENTS_4 = 0b010 << 4,
	SEGMENTS_8 = 0b011 << 4,
...
export enum NetworkLayerMessageType {
...
// ASHRE 135-2016 - 6.2.2 Network Layer Protocol Control Information - Enumerators
export enum NpduControlPriority {
	NORMAL_MESSAGE = 0b00,
	URGENT_MESSAGE = 0b01,
 ...
 */
export enum ReinitializedState {
	COLDSTART = 0,
	WARMSTART = 1,
	STARTBACKUP = 2,
	ENDBACKUP = 3,

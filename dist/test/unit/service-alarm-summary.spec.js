...
node_test_1.default.describe('bacnet - Services layer AlarmSummary unit', () => {
    (0, node_test_1.default)('should successfully encode and decode', () => {
        const buffer = utils.getBuffer();
        services_1.AlarmSummary.encode(buffer, [
            {
        ...
        const result = services_1.AlarmSummary.decode(buffer.buffer, 0, buffer.offset);
        delete result.len;
...
//# sourceMappingURL=service-alarm-summary.spec.js.map
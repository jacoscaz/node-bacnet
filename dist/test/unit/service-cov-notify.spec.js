...
node_test_1.default.describe('bacnet - Services layer COVNotify unit', () => {
    (0, node_test_1.default)('should successfully encode and decode', () => {
        const buffer = utils.getBuffer();
        const date = new Date(1, 1, 1);
        const time = new Date(1, 1, 1);
        time.setMilliseconds(990);
        services_1.CovNotify.encode(buffer, 7, 443, { type: 2, instance: 12 }, 120, [
            {
        ...
        const result = services_1.CovNotify.decode(buffer.buffer, 0, buffer.offset);
        delete result.len;
...
//# sourceMappingURL=service-cov-notify.spec.js.map